...
@Entity
@EntityListeners(ComentarioChangeListener.class)
...
@NamedQueries({
    ...
    @NamedQuery(name = "Comentario.findByProyecto", query = "SELECT c FROM Comentario c WHERE c.proyectoId.id = :id ORDER BY c.fecha")})
